...
public:
	...
	*/
	...
	/*!
	\param timeFrames Blinking frequency of each LEDs
	\param time Time since the last measurement
	\param modeON True if the light is ON, otherwide False
	\return void
	*/
	...
	*/
	...
	/*!
	\param p New coordinate of the area inside the picture
	\return void
	*/
	...
	/*!
	\param n New unique identification number of the area
	\return void
	*/
	...
	/*!
	\param t New time OFF of the area
	\return void
	*/
	...
	/*!
	\param t New time ON of the area
	\return void
	*/
